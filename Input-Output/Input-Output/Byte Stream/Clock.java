...
public class Clock extends JPanel implements Runnable{
	...
	g.setColor(Color.black);
	g.setFont(new Font("TimsRoman",Font.BOLD,30));
	...
	g.setColor(Color.black);
	g.setFont(new Font("TimesRoman",Font.BOLD,25));
	g.drawString("ANALOGH CLOCK",245,575);
	//String Written Text
	g.setColor(Color.blue);
    g.drawString("@Aadi",100,100);
	...
	public void paint(Graphics g){
        ...
        if(i<16){
			...
			xsec=(int)(-str[m-30]+xOrigin);
			ysec=(int)(str[n-1-i+30]+yOrigin);
		}
		else if(i<60){
			xsec=(int)(-str[m-1-i+45]+xOrigin);
			ysec=(int)(-str[n-45]+yOrigin);
			if(i==59){
				i=i-60;
			j++;
			}
