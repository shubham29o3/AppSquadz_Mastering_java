      ...
      if (c == '\n') {
         ...
         if (commandEnter.startsWith("urlinfo") || commandEnter.startsWith("urlinfo")) {
            ...
            while (tokenizer.hasMoreTokens()) {
               ...
               try {
                  ...
                  ta.append("" + token + "' avialbale data: \n");
         ...
         ///////////////// DIRECTORY///////////////
            ...
            try {
               ...
               p(dir.exists() ? "" : "The directory doesn't exists\n");
               String[] fileNames;
               fileNames = dir.list();
         ...
         //////////////////// RENAME FILE///////////
            ...
            try {
               ...
               if (oldFile.exists() == false)
                  ta.append("Error:File '" + oldFile + "'doesn't exists");
               token = tokenizer.nextToken();
         ...
         /////////////////////// EDIT//////////
            ...
            // ta.setText();
            editOn = true;
            myFrame.setTitle("NetDemo Console-Edit Mode (Type 'exit' to quite)-" + currentFile);
            ta.requestFocus();
         }
         ...
         ///////////////////////// CHECK MEMORY///////////
            ...
            ta.append("Initail free Memory: " + r.freeMemory() + " bytes" + "\n");
            r.gc();
            mem1 = r.freeMemory();
         ...
         /////////////////////////////////// HELP///////////////////////
            ...
            ta.append("  run         |    RunProgram              |      run calc notepad word prog\n");
            ta.append("  date        |     Shows Date             |      date\n");
            ta.append(" cls          |     Clear Screen           |      cls\n");
            ta.append(" cd           |     change directory       |      cd Prorams\n");
            ta.append(" copy         |      Copy files            |      copy readme.txt newreadme.txt\n");
            ta.append(" dir          |      Shows Directory       |      dir\n");
            ta.append(" memcheck     |      Checks Memory         |      dir\n");
            ta.append(" propmt       |      Changes prompt sign   |      prompt>>\n");
            ta.append(" urlinfo      | Gives URL information      |      urlinfo https://wwww.yahoo.com\n");
            ta.append(" sort         | Sorts given data           |      sort bad perfect great\n");
            ta.append(" edit         | Goes to the edit           |      edit filename(optional)\n");
            ta.append(" find         | Filnd the file             |      find prog.dbm hello.txt\n");
            ta.append(" kill         | Delete file                |      kill file1.txt file2.txt\n");
            ta.append(" save         | Saves file in edit mode    |      save fil1 file2.txt\n");
            ta.append(" local        | Shows country Time & Date  |      local Date and Time\n");
            ta.append(" nv           | Noraml video               |      nv\n");
            ta.append(" bv           | Black video                |      bv\n");
            ta.append(" gv           | Green video                |      gb\n");
            ...
            ta.append(" show         | Shows file content         |      show reame.txt\n");
            ...
            ta.append("              | Gives information of site  |      whois internic.net dotcom.in\n");
            ta.append(" quit         | Quits NetDemo              |      quit\n\n");
